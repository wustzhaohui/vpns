...
const Footer: React.FC = () => {
  ...
  const userAgreements = [
    { nameKey: 'footer.userAgreements.privacy', href: '/privacy-policy' },
    { nameKey: 'footer.userAgreements.terms', href: '/terms-of-service' },
    {
      nameKey: 'footer.userAgreements.registration',
      href: '/registration-agreement',
    },
  ];
  ...
  const desktopFooterSectionTitleFontSize = 'text-[1.8rem] md:text-[2rem]';
  const desktopFooterLinkFontSize = 'text-[1.4rem] md:text-[1.5rem]';
  ...
  return (
    <footer className="bg-white text-brand-text-primary">
      ...
      >
        <div
          className={`${
            isMobileView ? 'py-6' : 'py-12 lg:py-16'
          ...
          {isMobileView ? (
                        ...
                        <button
                          ...
                          className={`block w-full text-left px-4 py-2 text-[1.2rem] ${
                            currentLanguageKey === lang.code
                              ...
                              : 'text-brand-text-mobile-footer-links'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-y-10 md:gap-8">
              <div className="md:col-span-2 lg:col-span-1">
                ...
                <h4 className="text-[1.6rem] font-semibold text-brand-text-muted mb-3">
                  {t('footer.contactUs')}
                </h4>
                <div className="flex space-x-3 sm:mb-6">
                  {contactIcons.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      ...
                      rel="noopener noreferrer"
                      aria-label={item.label}
                      className="w-9 h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center transition-opacity duration-200 hover:opacity-75"
                    >
                      {item.icon}
                    </a>
                  ))}
                </div>
                <p className="text-[1.4rem] md:text-[1.5rem] text-gray-500 mt-4">
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-8 md:contents">
                <div>
                  <h3
                    className={`${desktopFooterSectionTitleFontSize} font-semibold text-brand-text-primary mb-5 md:mb-6`}
                  >
                    {t('footer.softwareDownloads.title')}
                  </h3>
